...
REPORTS_DIR = "results/prod/reports"
LOGS_DIR = "results/prod/logs"
SCREENSHOTS_DIR = "results/prod/screenshots"

# Default Test Tags
DEFAULT_INCLUDE_TAGS = ["smoke", "critical"]
DEFAULT_EXCLUDE_TAGS = ["manual", "debug", "performance"]
...
PARALLEL_WORKERS = 8
PABOT_OPTIONS = ["--verbose", "--outputdir", "results/prod", "--critical", "critical"]
