...
Run Complete E2E Benchmark Test Internal
    ...
    FINALLY
        ...
        IF    ${skip_cleanup}
            ...
            Log    ⚠️ Remember to manually delete these resources!    console=True
            Log    ========================================    console=True
...
Execute Policy Natural ID Retrieval Step
    ...
    FOR    ${policy}    IN    @{formatted_policies}
        ...
        Log    ✓ Policy: ${policy}    console=True
    ...
    Log    ========================================    console=True
    Log    ✅ Retrieved Natural IDs for ${policy_count} policies    console=True
    Log    ========================================    console=True
...
Execute Report Generation Step
    ...
    Log    ========================================    console=True
    Log    ✅ Generated ${policy_count} XCCDF reports    console=True
    Log    ========================================    console=True
...
Execute Report Validation Step
    ...
    FOR    ${var_name}    IN    @{policy_keys}
        ...
        IF    not ${has_latest}
            Log    ⚠️ Report ${report_id} has no status yet, waiting...    console=True
            Sleep    5s
            ${status_result}=    report_operations.Get Report Status    ${report_id}
        END
        ...
        WHILE    '${status_result}[latest_status]' == 'Started' and ${attempt} < ${max_attempts}
            ...
            Log    ⏳ Report ${var_name} generating (Attempt ${attempt}/${max_attempts}), waiting 10s...    console=True
            Sleep    10s
        ...
        Log    ✓ Report downloaded for ${var_name}    console=True
    END
    
    Log    \n================================================================================    console=True
    Log    📊 POLICY-WISE VALIDATION RESULTS    console=True
    Log    ================================================================================    console=True
    ...
    FOR    ${index}    ${report_content}    IN ENUMERATE    @{all_report_contents}
        ...
        Log    \n--------------------------------------------------------------------------------    console=True
        Log    📋 Policy: ${profile_filter}    console=True
        Log    --------------------------------------------------------------------------------    console=True
        ...
        TRY
            ...
            IF    ${total_rules} > 0
                ...
                Log    ✓ Rules Validated: ${total_rules}    console=True
                Log    ✓ Rules Passed: ${passed}    console=True
                Log    ✗ Rules Failed: ${failed}    console=True
                Log    📊 Success Rate: ${success_rate_formatted}%    console=True
    ...
    Log    \n================================================================================    console=True
    Log    ✅ OVERALL VALIDATION SUMMARY    console=True
    Log    ================================================================================    console=True
    Log    📁 Total Policies/Profiles Validated: ${report_count}    console=True
    Log    📝 Total Rules Validated: ${combined_total}    console=True
    Log    ✅ Total Rules Passed: ${combined_passed}    console=True
    Log    ❌ Total Rules Failed: ${combined_failed}    console=True
    Log    📊 Overall Success Rate: ${overall_success_rate_formatted}%    console=True
    Log    ================================================================================\n    console=True
...
Validate Compliance Results
    ...
    Log    Benchmark: ${benchmark} v${version}    console=True
    Log    ------------------------------------------------------------    console=True
    Log    📝 Total Controls Validated: ${total_controls}    console=True
    Log    ✅ Total Rules Passed: ${validation_passed}    console=True
    Log    ❌ Total Rules Failed: ${validation_failed}    console=True
    Log    📊 Compliance Rate: ${success_rate_formatted}%    console=True
    Log    ════════════════════════════════════════════════════════\n    console=True
